...
-- -----------------------------------------------------
-- Table `littleLemonDb`.`Reservations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `littleLemonDb`.`Reservations` (
...
-- -----------------------------------------------------
-- Table `littleLemonDb`.`Delivry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `littleLemonDb`.`Delivry` (
